...
public class MultiplicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener performMultiplication = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (value1EditText.getText().toString() != null && value2EditText.getText().toString() != null) {
                    ...
                    //check if the user has enter 0 value
                    if(value1 == 0 || value2 == 0){
                        showResult = 0;
                        result.setText("your result is  " + showResult);
                    }
                    showResult = multiplication(value1, value2);
                    result.setText("your result is " + showResult);
                }
        ...
        equalButton.setOnClickListener(performMultiplication);
    }
